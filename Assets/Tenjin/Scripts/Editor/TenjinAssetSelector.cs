...
namespace Tenjin
{
    internal class TenjinAssetTree : TreeView
    {
    ...
    internal class TenjinAssetViewItem : TreeViewItem
    {
    ...
    internal class TenjinAssetWindow : EditorWindow
    {
        [SerializeField] private TreeViewState m_TreeViewState;
        private TenjinAssetTree m_SimpleTreeView;
        ...
        private IEnumerable<string> SelectedAssets()
        {
